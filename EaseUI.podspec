Pod::Spec.new do |spec|
  ...
  spec.homepage     = 'https://github.com/sansuinanhai/easeui-ios-hyphenate-cocoapods'
  spec.author       = {'EaseMob Inc.' => 'admin@easemob.com'}
  spec.source       =  {:git => 'https://github.com/sansuinanhai/easeui-ios-hyphenate-cocoapods/xxxx.git', :tag => spec.version.to_s }
  ...
  spec.dependency 'MWPhotoBrowser', '~> 2.1.2'
